...
| 번호 | 내용 | 기간 |
|---|---|---|
| 1 | 마이페이지/메인페이지, 팀+매치 생성 구현 | 2025.09.01 ~ 2025.09.14 |
| 2 | 용병 모집/신청 구현 | 2025.09.15 ~ 2025.10.01 |
| 3 | 로그인, 회원가입 기능 구현 | 2025.10.02 ~ 2025.10.12 |
| 4 | 리뷰 시스템 구현 | 2025.10.13 ~ 2025.10.20 |
